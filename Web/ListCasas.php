  ...
  <div class="panel-body"> 
    <table id="lstCasas" class='table'>
      <thead><tr>
        ...
        <th style="width1:120px;" title="Localidad donde se ubica la casa">Localidad</th>
...
$(function() 
  ...
  $("#NewOperad").click(function(e) {document.location="EditCasa.php";} ); 
...
function DoQuery( page )
  ...
  var sQuery = "SELECT IdCasa, Propietario, Telef, Localidad, Cuartos, Personas, Precio, Comision, Notas FROM view_casas ";
  ...
  try
    ...
    if( nRows>0 || page==0) 
      ...
      for( i=0; i<nRows; ++i ) 
        ...
        sHtml += "</tr>"; 
//           0         1         2       3          4         5       6        7        8
// SELECT IdCasa, Propietario, Telef, Localidad, Cuartos, Personas, Precio, Comision, Notas FROM view_casas ";
        }
